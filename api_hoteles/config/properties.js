...
module.exports.MONGODB_URI = 'mongodb://localhost:27017/hotel_local';
module.exports.MYSQLDB_URI = 'mysql://root:root@127.0.0.1:3306/hotel_schema';

module.exports.PUBLIC_DIRECTORY = '/public';
module.exports.APPLICATION_DOMAIN = "localhost";
module.exports.APPLICATION_PORT = 3000;
